public class lesson {
//    имеется предложение состоящее из имен,
//    String str = "Ив@н Кирилл Ан@стасия Матвей Семен В@лерий Людмила Эдуард Филлип Алекс@ндр Петр Вячесл@в Ян";
//    в некоторых из них случайно указанна ошибка
//    вместо буквы А написанно @ требуется это исправить
//    если имя меньше либо равно 4 символам то перенести его в строку list1
//    если имя больше или равно 5 и меньше или равно 7 топеренести его в строку list2,
//    оставшиеся длинные имена перенести в строку list3
